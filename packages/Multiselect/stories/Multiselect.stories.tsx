...
const DemoComponent = () => {
  ...
  return (
    <div className="component-wrapper">
      ...
      <p>MultiSelect is a component that allows you to select multiple items with check boxes. It is useful for labeling, contact lists, country selectors, etc.</p>
