...
const MultiSelect: React.SFC<IMultiSelectProps & {
  ...
  formatMoreLabel?: (n: number) => string;
}> = ({
  ...
  ...attrs
    ...
    const getCheckedIds = (newDataCopy: IData[]) =>
      newDataCopy.reduce((acc: any, { checked, id }) => {
      ...
      <div className="form-field form-field--multiselect">
        <div className="multiselect" ref={multiRef}>
          <MultiSelectBar
            ...
            checkedPreviewCount={checkedPreviewCount}
            formatMoreLabel={formatMoreLabel}
...
MultiSelect.defaultProps = {
  ...
  onChange: (arg: { event: Event; value: string }) => arg,
  placeholder: 'Choose...',
  required: false,
