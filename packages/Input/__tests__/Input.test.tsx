...
describe("Input component", () => {
  ...
  test("Datetime - should handle when a date is provided by the parent component", () => {
    interface IOnChangeArgs {
      value: string;
      event: React.ChangeEvent<HTMLInputElement>;
    }

    let stateValue: string | Date = new Date('2020-01-01T12:00');
    ...
    const inputValue = '2020-01-01T10:00';
    ...
    expect(getByTestId("input")).toHaveValue(inputValue);
    expect(stateValue).toEqual(new Date(inputValue));
  });

  test("Datetime - should handle when a string is provided by the parent component", () => {
    interface IOnChangeArgs {
      value: string;
      event: React.ChangeEvent<HTMLInputElement>;
    }

    let stateValue: string | Date = '2020-01-01T12:00';
