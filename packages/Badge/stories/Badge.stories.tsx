    ...
    return (
      <Suspense fallback={<div>Loading...</div>}>
        <div className="component-wrapper">
          <h1>Badges</h1>
          <p>
            Badges are small components typically used to communicate a
            numerical value or indicate the status of an item to the user.
          </p>
          ...
          <h4>Icon</h4>
          <p>
            Icon and icon name needs to be passed as children props of Badge
          </p>
