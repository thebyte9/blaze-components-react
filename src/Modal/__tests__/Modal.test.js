...
describe('Modal component', () => {
  test('should be defined and renders correctly (snapshot)', () => {
    const wrapper = shallow(<Modal simple />);
  ...
  test('should render and close alert modal', () => {
    ...
    const wrapper = shallow(<Modal alert actions={actions} />);
  ...
  test('should render and close scrollable modal', () => {
    ...
    const wrapper = shallow(<Modal scrollable actions={actions} title="Scrollable Modal" />);
