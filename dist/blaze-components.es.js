...
var ButtonSelect = function ButtonSelect(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "material-icons"
  }, "keyboard_arrow_".concat(toggled ? 'up' : 'down')), text), toggled && React.createElement("div", {
...
var MoreAvatar = function MoreAvatar(_ref) {
  ...
  }, isHeader ? React.createElement(Fragment, null, React.createElement("span", {
    className: "dropdown__name"
  }, label), children) : React.createElement(Fragment, null, React.Children.map(children, function (child) {
...
export { Alert, Avatar, Badge, Breadcrumb, Button, ButtonSelect, Checkboxes as CheckBoxes, Dropdown, FileUpload, Input, Modal, More, MultiSelect as Multiselect, Progress, RadioButton, Select, SocialFollow, index as TabComponent, Table, Textarea, Tooltip, VideoContainer };
